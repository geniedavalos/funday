...
const TaskSchema = new mongoose.Schema({
  title: { type: String, minlength: [3, 'Title must be at least 3 characters long.'], unique: true },
  description: { type: String, minlength: [3, 'Description type must be at least 3 characters long.']},
  dueData: { type: Date},
